...
public class StanzaConstants {
  ...
  public final static boolean BOOK_DETAILS_CUSTOM_FIELDS_ALWAYS = false;
  public final static boolean INCLUDE_TAG_CROSS_REFERENCES = true;
  ...
  public final static boolean SortTagsByAuthor = false;
  public final static boolean TagBooksNoSplit = false;
  /* Book Details */
