...
public class JOutlookBar extends JTabbedPane {
   ...
   *
   * @param alignment one of {@link javax.swing.SwingConstants#LEFT},
  ...
  private class ExtendedPage {
    ...
    public void setTabAlignment(int alignment) {
      if (this.alignment != alignment) {
        ...
        JOutlookBar.this.firePropertyChange("tabPropertyChangedAtIndex", null, new Integer(getIndex()));
      }
    }
