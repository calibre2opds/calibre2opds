 ...
 * or IntelliJ).<br>
 *
 * @javabean.class name="JButtonBar"
 ...
 * @javabean.icons mono16="JButtonBar16-mono.gif"
...
public class JButtonBar extends JComponent implements SwingConstants {
   ...
   * @throws IllegalArgumentException if orientation is neither <code>
  ...
  public void setOrientation(int orientation) {
    ...
    if (this.orientation != orientation) {
      ...
      this.orientation = orientation;
      firePropertyChange(ORIENTATION_CHANGED_KEY, oldOrientation, this.orientation);
    }
  }
