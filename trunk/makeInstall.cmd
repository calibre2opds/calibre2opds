...
SET BASEVERSION=calibre2opds-3.5
...
"%ZIPPROG%" "%ZIPFILE%"  OpdsOutput-3.5-SNAPSHOT.jar  DataModel-3.5-SNAPSHOT.jar    Tools-3.5-SNAPSHOT.jar   CalibreQueryLanguage-3.5-SNAPSHOT.jar
