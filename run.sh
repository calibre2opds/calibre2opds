...
# Script file to start a Calibre2Opds that has just been built in batch mode
...
echo Starting Calibre2Opds [batch mode with assertions enabled]
../../../script/run.sh -enableassertions
cd ../../../
