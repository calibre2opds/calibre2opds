...
public class JOutlookBarAddon extends AbstractComponentAddon {
  ...
  protected void addBasicDefaults(LookAndFeelAddons addon, List defaults) {
    ...
    Border outlookBarBorder;
    {
      ...
      outlookBarButtonBorder = new WindowsOutlookBarUI.WindowsTabButtonBorder(color1, color2);
    ...
    Border outlookButtonBorder;
    {
      ...
      outlookButtonBorder = new BasicOutlookButtonUI.OutlookButtonBorder(color1, color2);
      outlookButtonBorder = new CompoundBorder(outlookButtonBorder, BorderFactory.createEmptyBorder(3, 3, 3, 3));
    }

    defaults.addAll(Arrays.asList(new Object[]{JOutlookBar.UI_CLASS_ID,
