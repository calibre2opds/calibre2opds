...
public class Book implements SplitableByLetter {
    ...
    public String getShortComment(int maxLength)
    {
        if (shortComment == null)
            shortComment = Helper.shorten(getComment(), maxLength);
        return shortComment;
    }
    ...
    public Book copy()
    {
        ...
        result.files = new Vector(this.getFiles());
        result.tags = new Vector(this.getTags());
        result.authors = new Vector(this.getAuthors());
